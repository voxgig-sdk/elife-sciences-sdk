...
local ElifeSciencesSDK = {}
ElifeSciencesSDK.__index = ElifeSciencesSDK
...
ElifeSciencesSDK._make_feature = _make_feature


function ElifeSciencesSDK.new(options)
  local self = setmetatable({}, ElifeSciencesSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function ElifeSciencesSDK:options_map()
...
function ElifeSciencesSDK:get_utility()
  return Utility.copy(self._utility)
end


function ElifeSciencesSDK:get_root_ctx()
  return self._rootctx
end


function ElifeSciencesSDK:prepare(fetchargs)
...
function ElifeSciencesSDK:direct(fetchargs)
...
-- by passing it.
function ElifeSciencesSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ElifeSciencesSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "ElifeSciencesSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function ElifeSciencesSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = ElifeSciencesSDK.new(sdkopts)
  sdk.mode = "test"
