...
describe("CollectionEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ELIFE_SCIENCES_TEST_COLLECTION_ENTID JSON to run live")
      return
    end
...
function collection_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ELIFE_SCIENCES_TEST_COLLECTION_ENTID")
