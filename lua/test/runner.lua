...
function runner.env_override(m)
  local live = runner.getenv("ELIFESCIENCES_TEST_LIVE")
  local override = runner.getenv("ELIFESCIENCES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ELIFESCIENCES_TEST_EXPLAIN")
