...
function runner.env_override(m)
  local live = runner.getenv("ELIFE_SCIENCES_TEST_LIVE")
  local override = runner.getenv("ELIFE_SCIENCES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ELIFE_SCIENCES_TEST_EXPLAIN")
