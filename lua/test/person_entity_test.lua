...
describe("PersonEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ELIFESCIENCES_TEST_PERSON_ENTID JSON to run live")
      return
    end
...
function person_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ELIFESCIENCES_TEST_PERSON_ENTID")
