...
local SDK_MODULE = "elife-sciences_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["annotation"] = { ["test01"] = { id = "test01" } }, ["article"] = { ["test01"] = { id = "test01" } }, ["collection"] = { ["test01"] = { id = "test01" } }, ["person"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } }, ["subject"] = { ["test01"] = { id = "test01" } } } }'
