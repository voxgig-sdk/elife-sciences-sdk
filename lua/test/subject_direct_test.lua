...
describe("SubjectDirect", function()
  it("should direct-load-subject", function()
    local setup = subject_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-subject", setup.live and "live" or "unit")
...
function subject_direct_setup(mockres)
