...
describe("AnnotationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ELIFE_SCIENCES_TEST_ANNOTATION_ENTID JSON to run live")
      return
    end
...
function annotation_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ELIFE_SCIENCES_TEST_ANNOTATION_ENTID")
