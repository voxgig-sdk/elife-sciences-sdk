...
class PersonEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ELIFE_SCIENCES_TEST_PERSON_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def person_basic_setup(extra)
  ...
  entid_env_raw = ENV["ELIFE_SCIENCES_TEST_PERSON_ENTID"]
