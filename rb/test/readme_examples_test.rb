...
#      offline in seeded test mode (ElifeSciencesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ElifeSciences_sdk.rb")
  SDK_CLASS = "ElifeSciencesSDK"
