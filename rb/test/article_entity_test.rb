...
class ArticleEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ELIFE_SCIENCES_TEST_ARTICLE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def article_basic_setup(extra)
  ...
  entid_env_raw = ENV["ELIFE_SCIENCES_TEST_ARTICLE_ENTID"]
