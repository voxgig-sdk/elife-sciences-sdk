# ElifeSciences SDK Collection entity
...
class CollectionEntity
  ...
  #   as an empty match, so client.Collection.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Collection, Hash] the loaded Collection; raises ElifeSciencesError on failure
