# ElifeSciences SDK Subject entity
...
class SubjectEntity
  ...
  def make
    opts = @_entopts.dup
    SubjectEntity.new(@_client, opts)
  end
  ...
  # @return [Subject, Hash] the current Subject data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Subject fields)
  def match_get
  ...
  #
  # @param reqmatch [SubjectLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Subject.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Subject, Hash] the loaded Subject; raises ElifeSciencesError on failure
