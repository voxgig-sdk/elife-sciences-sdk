...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/elife-sciences` | `npm install @voxgig-sdk/elife-sciences` |
| Python | `voxgig-sdk-elife-sciences` | `pip install voxgig-sdk-elife-sciences` |
| PHP | `voxgig-sdk/elife-sciences` | `composer require voxgig-sdk/elife-sciences` |
| Golang | `github.com/voxgig-sdk/elife-sciences-sdk/go` | `go get github.com/voxgig-sdk/elife-sciences-sdk/go` |
| Ruby | `voxgig-sdk-elife-sciences` | `gem install voxgig-sdk-elife-sciences` |
| Lua | `voxgig-sdk-elife-sciences` | `luarocks install voxgig-sdk-elife-sciences` |
