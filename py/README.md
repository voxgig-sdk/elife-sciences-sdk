# ElifeSciences Python SDK



The Python SDK for the ElifeSciences API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/elife-sciences-sdk/releases)) or
...
```
py/
├── elifesciences_sdk.py         -- Main SDK module
