...
from elifesciences_sdk.core.control import ElifeSciencesControl
...
from elifesciences_sdk.core.helpers import get_ctx_prop, to_map
...
class ElifeSciencesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ElifeSciencesControl()
        ...
        if isinstance(sp, ElifeSciencesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ElifeSciencesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ElifeSciencesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ElifeSciencesError(code, msg, self)
