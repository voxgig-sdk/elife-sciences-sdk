...
from elifesciences_sdk.utility import register

# Load features
from elifesciences_sdk.feature.base_feature import ElifeSciencesBaseFeature
from elifesciences_sdk.features import _has_feature, _make_feature
...
class ElifeSciencesSDK:
    ...
    def get_utility(self):
        return ElifeSciencesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ElifeSciencesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Annotation(self, data=None) -> "AnnotationEntity":
        ...
        from elifesciences_sdk.entity.annotation_entity import AnnotationEntity
    ...
    def Article(self, data=None) -> "ArticleEntity":
        ...
        from elifesciences_sdk.entity.article_entity import ArticleEntity
    ...
    def Collection(self, data=None) -> "CollectionEntity":
        ...
        from elifesciences_sdk.entity.collection_entity import CollectionEntity
    ...
    def Person(self, data=None) -> "PersonEntity":
        ...
        from elifesciences_sdk.entity.person_entity import PersonEntity
        return PersonEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from elifesciences_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)


    def Subject(self, data=None) -> "SubjectEntity":
        """Entity factory: client.Subject().list() / client.Subject().load({"id": ...})."""
        from elifesciences_sdk.entity.subject_entity import SubjectEntity
