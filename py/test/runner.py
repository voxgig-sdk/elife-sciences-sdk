...
class ElifeSciencesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ElifeSciencesTestRunner.getenv("ELIFESCIENCES_TEST_LIVE")
        override = ElifeSciencesTestRunner.getenv("ELIFESCIENCES_TEST_OVERRIDE")
        ...
        explain = ElifeSciencesTestRunner.getenv("ELIFESCIENCES_TEST_EXPLAIN")
