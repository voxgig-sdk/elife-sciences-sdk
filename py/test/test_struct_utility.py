...
from elifesciences_sdk.utility.voxgig_struct.voxgig_struct import (
...
runner = makeRunner(STRUCT_TEST_JSON, ElifeSciencesSDK.test(None, None))
...
class TestStructUtility(unittest.TestCase):
    ...
    def test_minor_joinurl(self):
        from elifesciences_sdk.utility.voxgig_struct.voxgig_struct import join as struct_join
