# ElifeSciences SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ElifeSciencesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ElifeSciencesSDK(...) and ElifeSciencesSDK.test(...) become
#      ElifeSciencesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "elifesciences_sdk"
_SDK_CLASS = "ElifeSciencesSDK"
