# ElifeSciences SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from elifesciences_sdk import ElifeSciencesSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"ElifeSciencesSDK": ElifeSciencesSDK, "os": os}
        try:
