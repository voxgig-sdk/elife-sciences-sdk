...
// ElifeSciences SDK utility type

class ElifeSciencesUtility
{
    ...
    public static function copy(ElifeSciencesUtility $src): ElifeSciencesUtility
    {
        $u = new ElifeSciencesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
