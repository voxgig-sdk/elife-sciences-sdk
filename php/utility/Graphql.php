...
// ElifeSciences SDK utility: graphql
//
...
class ElifeSciencesGraphql
{
    ...
    // equivalent.
    public static function body(ElifeSciencesContext $ctx): mixed
    {
    ...
    public static function errors(ElifeSciencesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
