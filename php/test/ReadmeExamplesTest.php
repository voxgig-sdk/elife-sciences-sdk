...
// ElifeSciences SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ElifeSciencesSDK::test)
...
{
    private const SDK_CLASS = 'ElifeSciencesSDK';
    ...
    private const SDK_BASE = 'elifesciences_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../elifesciences_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
