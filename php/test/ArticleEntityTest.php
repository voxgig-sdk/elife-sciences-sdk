...
class ArticleEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ELIFE_SCIENCES_TEST_ARTICLE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function article_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ELIFE_SCIENCES_TEST_ARTICLE_ENTID");
