...
class AnnotationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ELIFE_SCIENCES_TEST_ANNOTATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function annotation_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ELIFE_SCIENCES_TEST_ANNOTATION_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["ELIFE_SCIENCES_TEST_ANNOTATION_ENTID"]);
