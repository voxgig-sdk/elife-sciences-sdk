...
// ElifeSciences SDK proxy feature
...
class ElifeSciencesProxyFeature extends ElifeSciencesBaseFeature
{
    ...
    public function init(ElifeSciencesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ElifeSciencesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
