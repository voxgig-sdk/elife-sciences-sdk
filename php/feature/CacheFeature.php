...
// ElifeSciences SDK cache feature
...
class ElifeSciencesCacheFeature extends ElifeSciencesBaseFeature
{
    ...
    private function _through(ElifeSciencesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
