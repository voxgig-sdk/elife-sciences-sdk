...
// ElifeSciences SDK ratelimit feature
...
class ElifeSciencesRatelimitFeature extends ElifeSciencesBaseFeature
{
    ...
    private function _acquire(ElifeSciencesContext $ctx): void
    {
    ...
    private function _track(ElifeSciencesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
