...
// ElifeSciences SDK debug feature
...
class ElifeSciencesDebugFeature extends ElifeSciencesBaseFeature
{
    ...
    private function _finish(ElifeSciencesContext $ctx, bool $ok): void
    {
