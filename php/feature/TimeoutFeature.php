...
// ElifeSciences SDK timeout feature
...
class ElifeSciencesTimeoutFeature extends ElifeSciencesBaseFeature
{
    ...
    private function _with_timeout(ElifeSciencesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ElifeSciencesContext $_ctx, float $ms): void
    {
        $client = $this->client;
