// Command ElifeSciences-cli is a CLI + REPL for the ElifeSciences SDK,
...
const prompt = "elife-sciences"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "annotation article collection person search subject"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ELIFE_SCIENCES_APIKEY (api key), ELIFE_SCIENCES_BASE (base url override)")
