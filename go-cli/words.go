...
func registerSDKWords(r *eng.Registry, client *sdk.ElifeSciencesSDK) {
...
func runOp(client *sdk.ElifeSciencesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
