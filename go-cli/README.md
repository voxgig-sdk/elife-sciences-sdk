...
AQL-driven CLI and REPL for the ElifeSciences SDK. Positional arguments are
...
./elife-sciences-cli list annotation
./elife-sciences-cli load 1 annotation
./elife-sciences-cli load '{id:1}' annotation
