...
func NewAnnotationEntity(client *core.ElifeSciencesSDK, entopts map[string]any) *AnnotationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnnotationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AnnotationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AnnotationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
