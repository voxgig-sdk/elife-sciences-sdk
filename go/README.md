...
The Golang SDK for the ElifeSciences API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/elife-sciences-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/elife-sciences-sdk=../path/to/github.com/voxgig-sdk/elife-sciences-sdk
```
...
```
github.com/voxgig-sdk/elife-sciences-sdk/
...
The root package (`github.com/voxgig-sdk/elife-sciences-sdk`) re-exports everything needed
