...
func (sdk *ElifeSciencesSDK) OptionsMap() map[string]any {
...
func (sdk *ElifeSciencesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ElifeSciencesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ElifeSciencesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ElifeSciencesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ElifeSciencesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ElifeSciencesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ElifeSciencesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ElifeSciencesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ElifeSciencesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ElifeSciencesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ElifeSciencesSDK {
	...
	sdk := NewElifeSciencesSDK(sdkopts)
	sdk.Mode = "test"
