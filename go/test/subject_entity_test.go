...
func TestSubjectEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set ELIFESCIENCES_TEST_SUBJECT_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func subjectBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("ELIFESCIENCES_TEST_SUBJECT_ENTID")
