...
const testSeed = `map[string]any{"entity": map[string]any{"annotation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "article": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "person": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subject": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
