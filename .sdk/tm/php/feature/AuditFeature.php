...
// ElifeSciences SDK audit feature
...
class ElifeSciencesAuditFeature extends ElifeSciencesBaseFeature
{
    ...
    private function _emit(ElifeSciencesContext $ctx, string $outcome): void
    {
