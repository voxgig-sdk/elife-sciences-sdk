...
// ElifeSciences SDK rbac feature
...
class ElifeSciencesRbacFeature extends ElifeSciencesBaseFeature
{
    ...
    private function _required(ElifeSciencesContext $ctx): ?string
    {
    ...
    private function _reject(ElifeSciencesContext $ctx, string $required): void
    {
    ...
    private function _track(ElifeSciencesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
