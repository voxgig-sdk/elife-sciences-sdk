...
// ElifeSciences SDK netsim feature
...
class ElifeSciencesNetsimFeature extends ElifeSciencesBaseFeature
{
    ...
    private function _simulate(ElifeSciencesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ElifeSciencesContext $ctx, array $applied): void
    {
        $client = $this->client;
