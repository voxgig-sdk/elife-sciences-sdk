...
// ElifeSciences SDK clienttrack feature
...
class ElifeSciencesClienttrackFeature extends ElifeSciencesBaseFeature
{
    ...
    public function PostConstruct(ElifeSciencesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ElifeSciences-SDK';
