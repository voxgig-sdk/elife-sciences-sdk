...
// ElifeSciences SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ElifeSciencesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ElifeSciencesOmni::structfix($now, Struct::undef()))
                        !== json_encode(ElifeSciencesOmni::structfix($val, Struct::undef()))) {
