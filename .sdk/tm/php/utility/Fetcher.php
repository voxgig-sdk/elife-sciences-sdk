...
class ElifeSciencesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ElifeSciencesSDK/1.0)';
    ...
    public static function call(ElifeSciencesContext $ctx, string $fullurl, array $fetchdef): array
    {
