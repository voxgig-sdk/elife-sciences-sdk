...
// ElifeSciences SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ElifeSciencesMakeRequest
{
    public static function call(ElifeSciencesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ElifeSciencesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ElifeSciencesResponse($fetched);
        } else {
