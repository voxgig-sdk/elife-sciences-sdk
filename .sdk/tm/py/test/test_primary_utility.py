...
_runner = makeRunner(TEST_JSON_FILE, ElifeSciencesSDK.test(None, None))
...
def _auth_credential():
    ...
    ctx.spec = ElifeSciencesSpec({"headers": {}, "query": {}})
    try:
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ElifeSciencesSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ElifeSciencesSDK.test(None, setup.get('a') or {})
