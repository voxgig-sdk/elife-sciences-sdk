...
class ElifeSciencesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ElifeSciencesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ElifeSciencesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ElifeSciencesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
