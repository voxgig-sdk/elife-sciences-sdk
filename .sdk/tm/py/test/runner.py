...
class ElifeSciencesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ElifeSciencesTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ElifeSciencesTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ElifeSciencesTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
