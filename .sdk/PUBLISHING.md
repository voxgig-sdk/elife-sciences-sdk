...
|---|---|---|
| `ts/` | @voxgig-sdk/elife-sciences-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/elife-sciences-sdk \
      --repository voxgig-sdk/elife-sciences-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/elife-sciences-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/elife-sciences-sdk --id=<id>` removes one.
