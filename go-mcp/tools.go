...
type Args struct {
	Entity string         `json:"entity" jsonschema:"annotation | article | collection | person | search | subject"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ElifeSciencesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "elife-sciences_list",
		Description: "List records from ElifeSciences. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "elife-sciences_load",
		Description: "Load a single record from ElifeSciences. " +
...
func runOp(client *sdk.ElifeSciencesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ElifeSciencesSDK, name string) (sdk.ElifeSciencesEntity, error) {
