// Command ElifeSciences-mcp is an MCP server exposing the ElifeSciences
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ElifeSciences_list  — list records of an entity
//	ElifeSciences_load  — load a single record of an entity
//
