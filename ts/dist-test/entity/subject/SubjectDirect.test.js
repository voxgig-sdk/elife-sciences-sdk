...
(0, node_test_1.describe)('SubjectDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ElifeSciencesSDK({
    ...
    (0, node_test_1.test)('direct-load-subject', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-subject', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ELIFE_SCIENCES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'ELIFE_SCIENCES_TEST_SUBJECT_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.ElifeSciencesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ELIFE_SCIENCES_TEST_SUBJECT_ENTID'];
    ...
    const client = new __1.ElifeSciencesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SubjectDirect.test.js.map