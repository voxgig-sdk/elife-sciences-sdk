...
function envOverride(m) {
    if ('TRUE' === process.env.ELIFE_SCIENCES_TEST_LIVE ||
        'TRUE' === process.env.ELIFE_SCIENCES_TEST_OVERRIDE) {
    ...
    m.ELIFE_SCIENCES_TEST_EXPLAIN = process.env.ELIFE_SCIENCES_TEST_EXPLAIN || m.ELIFE_SCIENCES_TEST_EXPLAIN;
    return m;
}
